...
{{--                            <input type="number" placeholder="Min" class="filter-input" wire:model.live="minPrice">--}}
{{--                            <span>-</span>--}}
{{--                            <input type="number" placeholder="Max" class="filter-input" wire:model.live="maxPrice">--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                                            <a href="{{ route('product.detail', ['productId' => $pd->id]) }}"> </a>--}}
